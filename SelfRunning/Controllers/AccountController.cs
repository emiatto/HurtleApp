...
using SelfRunning.Models.AccountViewModels;
...
namespace SelfRunning.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            ILogger<AccountController> logger, IRunnerRepository runnerRepository)
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction(nameof(HurtleController.Index), "Hurtle");
        }
